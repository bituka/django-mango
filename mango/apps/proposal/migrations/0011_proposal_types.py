...
from proposal.models import ProposalType


class Migration(DataMigration):
    raw_proposal_types = ['Tutorial', 'Talk', 'Poster']

    def forwards(self, orm):
        for raw_proposal_type in self.raw_proposal_types:
            proposal_type = ProposalType(name=raw_proposal_type)
            proposal_type.save()

    def backwards(self, orm):
        ProposalType.objects.filter(
            name__in=self.raw_proposal_types).delete()
