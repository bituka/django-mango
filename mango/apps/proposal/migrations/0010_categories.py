...
from proposal.models import Category


class Migration(DataMigration):
    raw_default_categories = ['Best Practices/Patterns', 'Big Data', 'Business',
        'Cloud', 'Community', 'Concurrency', 'Core Python (Language, Stdlib)',
        'Databases/NoSQL', 'Distributed Computing', 'Documentation',
        'Education', 'Embedded Systems', 'GUI Programming', 'Gaming',
        'High Performance Computing', 'Industry Uses', 'Mobile', 'Other',
        'Packaging', 'Python Internals', 'Science', 'Systems Administration',
        'Testing', 'Useful libraries', 'Web Frameworks']

    def forwards(self, orm):
        for raw_category in self.raw_default_categories:
            category = Category(name=raw_category)
            category.save()

    def backwards(self, orm):
        Category.objects.filter(
            name__in=self.raw_default_categories).delete()
