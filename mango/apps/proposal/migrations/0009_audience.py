...
from proposal.models import AudienceLevel


class Migration(DataMigration):
    raw_default_audience = ['Novice', 'Intermediate', 'Experienced']

    def forwards(self, orm):
        for raw_audience in self.raw_default_audience:
            audience = AudienceLevel(name=raw_audience)
            audience.save()

    def backwards(self, orm):
        AudienceLevel.objects.filter(
            name__in=self.raw_default_audience).delete()
